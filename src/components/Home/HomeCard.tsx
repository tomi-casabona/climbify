export const HomeCard = ({
  ...
  return (
    <div className="mx-5 active:scale-105 duration-200 my-5 p-[1px] bg-gradient-to-b opacity from-neutral-content to-base-100 rounded-full">
      <div className="p-5 bg-base-100 rounded-full flex justify-between items-center">
        ...
        <div className="text-3xl px-5 font-light text-primary">
          {mainNumber}
        </div>
      </div>
    </div>
